...
\begin{enumerate}
	...
	\begin{figure}[H]
		...
		\begin{itemize}
			\item \textit{}{Browse} : berfungsi untuk membuka \textit{pop-up window} sebagai sarana pengguna memilih file excel yang akan dimasukan.
			\item \textit{Textbox path} : alamat file yang telah dipilih oleh pengguna akan dicatat pada \textit{textbox} ini.
			\item \textit{Convert} : tombol ini berfungsi mengeksekusi program untuk membaca file yang telah dimasukan oleh pengguna.
